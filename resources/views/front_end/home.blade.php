...
<div class="row">
    <div class="col-md-12">
                        ...
                        <div class="col-md-6 wow fadeInLeft animated">
                            <div class="tlmd-join-doctor ">
                                ...
                                <div style="text-align: right">
                                    <a href="<?php echo URL::route('doctorRegDetail'); ?>"
                                       class="more-details-specialize hvr-float " style="color:#f10026;"><i
                                                class="fa fa fa-user-md"></i> More Details</a>
                                </div>
                        ...
                        <div class="col-md-6  wow fadeInRight animated">
                            <div class="tlmd-join-patient">
                                ...
                                <p>Lorem Ipsum is simply dummy text
                                    ...
                                    type and scrambled it to make a type specimen book</p>
                                <div style="text-align: right">
                                    <a href="<?php echo URL::route('patientRegDetail'); ?>"
                                       class="more-details-specialize hvr-float" style="color:#a600a6;"><i
                                                class="fa fa fa-user-md"></i> More Details</a>
                                </div>
                            </div>
                        </div>
        ...
        <div style="background:#ddd; padding-bottom: 60px;">
            <div class="container">
            ...
            <div class="row">
                 <div class="col-md-4 wow fadeInRightBig animated">
            ...
            <div class="row">
                 <div class="col-md-4 wow fadeInLeftBig animated">
                     <div class="tlmd-single-special-doctor" style="background:#3415b0;">
