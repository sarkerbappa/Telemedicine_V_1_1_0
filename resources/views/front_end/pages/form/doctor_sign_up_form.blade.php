...
@section('content')
    ...
    <div class="row">
           ...
           <div class="col-md-7  wow fadeInLeftBig animated">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    ...
                    <?php echo Form::hidden('role',$value="doctor"); ?>
        ...
        <div class="col-md-5  wow fadeInRightBig animated">
            <div class="tlmd_form_page_image inner_body_content_wrapper_doctor_image">
                <img src="{{URL::to('public/assets/frontend/img/doctor.png')}}"  />
            </div>
        </div>
    </div>
