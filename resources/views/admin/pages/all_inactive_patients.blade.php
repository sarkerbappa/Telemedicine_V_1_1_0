...
@section('content')
    <section class="content-header">
        <h1>
            All Inactive Patients
            <small> All are waiting for activation.</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php
                            if(isset($all_inactive_patients))
                            foreach($all_inactive_patients as  $single_patients){?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href ="" data-toggle="modal"  data-target="#patientDetailModal" class=" user_details" id="<?php echo $single_patients->id ?>"><i class="fa fa-eye"></i> View</a></li>
                                            <li>
                                                <a href="<?php echo $single_patients->status === 1 ? URL::action('Admin\Patient@deactivatePatient', [$single_patients->id]) : URL::action('Admin\Patient@activatePatient', [$single_patients->id]) ?>"> <i class="fa fa-angle-up"></i><?php echo $single_patients->status === 1 ? 'Deactivate' : 'Activate'; ?></a>
                                            </li>
