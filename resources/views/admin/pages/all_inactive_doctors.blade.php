...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">All Inactive Doctors</li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table  id="example1" class="table table-bordered table-striped">
                            ...
                            <?php
                            if(isset($all_inactive_doctors))
                            foreach($all_inactive_doctors as  $single_doctor){?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href ="" data-toggle="modal" data-target="#doctorDetailModal" class=" user_details" id="<?php echo $single_doctor->id ?>">View</a></li>
                                            <li><a href="<?php echo $single_doctor->status ===1?URL::action('Admin\Doctor@deactivateDoctor', [$single_doctor->id]):URL::action('Admin\Doctor@activateDoctor', [$single_doctor->id]) ?>"><?php echo $single_doctor->status ===1?'Deactivate':'Activate'; ?></a></li>
